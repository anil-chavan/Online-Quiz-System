...
<a href="index.php" class="pull-right btn sub1 title3"><span class="" aria-hidden="true"></span>&nbsp;Home</a>&nbsp;
</div></div>
...
<div class="col-md-6 panel" style="background-image:url(image/th.jpg); min-height:430px;">
<h2 align="center" style="font-family:'typo'; color:#000066">FEEDBACK/REPORT A PROBLEM</h2>
<div style="font-size:14px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 
...
<div class="col-md-10">
<a href="mailto:anilchavan@gmail.com" style="color: 	#0000FF;">anilchavan@gmail.com</a><br /><br />
